...
# **roles_list**
> InlineResponse20041 roles_list(id=id, name=name, limit=limit, offset=offset)
...
offset = 56 # int | The initial index from which to return the results. (optional)
    ...
    try:
        api_response = api_instance.roles_list(id=id, name=name, limit=limit, offset=offset)
        pprint(api_response)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.roles_read(id)
        pprint(api_response)
    except ApiException as e:
