...
# **users_list**
> InlineResponse20056 users_list(id=id, username=username, first_name=first_name, last_name=last_name, email=email, is_active=is_active, is_superuser=is_superuser, limit=limit, offset=offset)
...
is_superuser = 'is_superuser_example' # str |  (optional)
limit = 56 # int | Number of results to return per page. (optional)
offset = 56 # int | The initial index from which to return the results. (optional)

    try:
        api_response = api_instance.users_list(id=id, username=username, first_name=first_name, last_name=last_name, email=email, is_active=is_active, is_superuser=is_superuser, limit=limit, offset=offset)
        pprint(api_response)
    except ApiException as e:
