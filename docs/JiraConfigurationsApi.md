...
> JIRAInstance jira_configurations_create(data)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.JiraConfigurationsApi(api_client)
...
> InlineResponse20014 jira_configurations_list(id=id, url=url, limit=limit, offset=offset)
...
> JIRAInstance jira_configurations_partial_update(id, data)
...
> JIRAInstance jira_configurations_read(id)
...
> JIRAInstance jira_configurations_update(id, data)
