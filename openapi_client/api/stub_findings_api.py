...
class StubFindingsApi(object):
    ...
    def stub_findings_delete(self, id, **kwargs):  # noqa: E501
        """stub_findings_delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stub_findings_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.stub_findings_delete_with_http_info(id, **kwargs)  # noqa: E501

    def stub_findings_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """stub_findings_delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stub_findings_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method stub_findings_delete" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `stub_findings_delete`")  # noqa: E501
