...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.JiraFindingMappingsApi(api_client)
...
> InlineResponse20015 jira_finding_mappings_list(limit=limit, offset=offset)
...
offset = 56 # int | The initial index from which to return the results. (optional)
    ...
    try:
        api_response = api_instance.jira_finding_mappings_list(limit=limit, offset=offset)
        pprint(api_response)
    except ApiException as e:
