...
> JIRAProject jira_product_configurations_create(data)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.JiraProductConfigurationsApi(api_client)
...
> InlineResponse20016 jira_product_configurations_list(limit=limit, offset=offset)
...
offset = 56 # int | The initial index from which to return the results. (optional)
    ...
    try:
        api_response = api_instance.jira_product_configurations_list(limit=limit, offset=offset)
        pprint(api_response)
    except ApiException as e:
...
> JIRAProject jira_product_configurations_partial_update(id, data)
...
> JIRAProject jira_product_configurations_read(id)
...
> JIRAProject jira_product_configurations_update(id, data)
