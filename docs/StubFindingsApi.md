...
[**stub_findings_delete**](StubFindingsApi.md#stub_findings_delete) | **DELETE** /stub_findings/{id}/ | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.StubFindingsApi(api_client)
...
# **stub_findings_delete**
> stub_findings_delete(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.stub_findings_delete(id)
    except ApiException as e:
        print("Exception when calling StubFindingsApi->stub_findings_delete: %s\n" % e)
```
...
# **stub_findings_list**
> InlineResponse20044 stub_findings_list(limit=limit, offset=offset)
