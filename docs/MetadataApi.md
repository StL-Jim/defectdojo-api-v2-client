...
# **metadata_list**
> InlineResponse20020 metadata_list(limit=limit, offset=offset, prefetch=prefetch)
...
prefetch = ['prefetch_example'] # list[str] |  (optional)
    ...
    try:
        api_response = api_instance.metadata_list(limit=limit, offset=offset, prefetch=prefetch)
        pprint(api_response)
    except ApiException as e:
...
# **metadata_read**
> InlineResponse20021 metadata_read(id, prefetch=prefetch)
...
prefetch = ['prefetch_example'] # list[str] |  (optional)
    ...
    try:
        api_response = api_instance.metadata_read(id, prefetch=prefetch)
        pprint(api_response)
    except ApiException as e:
