...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.NoteTypeApi(api_client)
    data = openapi_client.NoteType() # NoteType | 
...
# **note_type_list**
> InlineResponse20023 note_type_list(id=id, name=name, description=description, is_single=is_single, is_active=is_active, is_mandatory=is_mandatory, limit=limit, offset=offset)
