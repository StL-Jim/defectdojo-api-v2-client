...
# **notes_list**
> InlineResponse20024 notes_list(id=id, entry=entry, author=author, private=private, date=date, edited=edited, edit_time=edit_time, editor=editor, limit=limit, offset=offset)
