...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TestTypesApi(api_client)
...
# **test_types_list**
> InlineResponse20049 test_types_list(name=name, limit=limit, offset=offset)
...
offset = 56 # int | The initial index from which to return the results. (optional)
    ...
    try:
        api_response = api_instance.test_types_list(name=name, limit=limit, offset=offset)
        pprint(api_response)
    except ApiException as e:
