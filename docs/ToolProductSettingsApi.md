...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ToolProductSettingsApi(api_client)
...
> InlineResponse20052 tool_product_settings_list(limit=limit, offset=offset)
...
offset = 56 # int | The initial index from which to return the results. (optional)
    ...
    try:
        api_response = api_instance.tool_product_settings_list(limit=limit, offset=offset)
        pprint(api_response)
    except ApiException as e:
