# openapi_client.SystemSettingsApi
...
> InlineResponse20045 system_settings_list(limit=limit, offset=offset)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SystemSettingsApi(api_client)
...
data = openapi_client.SystemSettings() # SystemSettings | 
